module.exports = {
  siteUrl: "https://eyalh.co.il", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "eyalh", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
    "eyalh", // This allows an alternative site description for meta data for pages.

  shareImageWidth: 1000, // Change to the width of your default share image
  shareImageHeight: 523, // Change to the height of your default share image

  shortTitle: "eyalh", // Used for App manifest e.g. Mobile Home Screen
  ...
  header: {
    navigation: [
      {
        label: "דף הבית",
        url: "https://eyalh.co.il/",
      },
      {
        label: "יצירת קשר",
        url: "https://eyalh.co.il/contact",
      },
    ],
  },
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://eyalh.co.il/sitemap.xml",
      },
